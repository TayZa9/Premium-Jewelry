      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <button aria-label="Account" className="hover:text-primary transition-colors"><User size={20} strokeWidth={1.5} /></button>
      ...
      {isMobileMenuOpen && (
        ...
        >
          ...
          <div className="flex space-x-6 pt-4 border-t border-gray-100">
            ...
            <button aria-label="Account"><User size={20} strokeWidth={1.5} /></button>
            <button aria-label="Cart"><ShoppingBag size={20} strokeWidth={1.5} /></button>
          </div>
        </motion.div>
      )}
    </header>
