      ...
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="space-y-12">
          <div className="border-b border-white/10 pb-8">
             ...
             <p className="text-gray-400 font-light tracking-wide italic">You will receive a tracking number via email once your order has been dispatched.</p>
          </div>
          <div className="border-b border-white/10 pb-8">
             <h3 className="text-lg font-serif tracking-wider text-foreground mb-4 uppercase">Are your diamonds ethically sourced?</h3>
             <p className="text-gray-400 font-light tracking-wide italic">Every AURA diamond is sourced through the Kimberley Process and meets the highest ethical standards.</p>
          </div>
        </div>
      </div>
    </div>
